...
<a href="https://daily-budget-app-lime.vercel.app/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border border-black/20 rounded-full px-5 py-2.5 text-sm text-neutral-500 hover:border-black hover:text-black transition-colors no-underline my-8 not-prose">Try the app live →</a>

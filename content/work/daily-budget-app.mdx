...
<div style={{width:"671px",margin:"3rem auto",overflow:"hidden",lineHeight:0}}>
  <video src="/videos/candy.mp4" autoPlay muted loop playsInline style={{display:"block",width:"671px",height:"auto",border:"none",outline:"none"}} />
</div>

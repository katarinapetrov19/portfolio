...
type: "Side project / shipped product"
output: "Live app + iOS widget"
---
...
<div className="candy-video">
  <video src="/videos/candy.mp4" autoPlay muted loop playsInline />
</div>

<a href="https://daily-budget-app-lime.vercel.app/" target="_blank" rel="noopener noreferrer">View app →</a>
